...
def run_rope(
    ...
    layer = RotaryPositionalEmbedding(d_k, theta, max_seq_len, device=in_query_or_key.device)
...
def run_transformer_block(
    ...
    mapping = {
        ...
        "attn.output_proj.weight": block.attn.o_proj.weight,
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    return softmax(in_features, dim=-1)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.clip import clip_gradient_norm
